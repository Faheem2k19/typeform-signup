...
const apercuPro = localFont({
  src: [{
    path: "../../public/font/apercu_regular_pro.otf"
  }],
...
export default function Home() {
  ...
  return (
    <main className={apercuPro.variable}>
      <div className="flex">
        <div className="grow hidden md:hidden lg:block h-screen" style={{ backgroundColor: "rgb(25, 25, 25)" }}>
          <div className="flex flex-col justify-center items-center h-full">
            <div className="flex flex-col items-center justify-center h-full">
              <div>
                <h1 className="jfDCYB font-sans">Sign up <br /> and come on in</h1>
                <img src="/assets/signup-img.webp" alt="Typeform Logo" className="dTTneq" />
              </div>
              <p className="cfbhxT font-sans">© Typeform</p>
            </div>
          </div>
        </div>
        <div className="grow bg-white h-screen rounded-tl-2xl rounded-bl-2xl">
          ...
          <div className="flex flex-col justify-center items-center h-full max-w-xs lg:max-w-xl mx-auto">
            ...
            <h2 className="fZkklZ font-sans">Get better data with conversational forms, surveys, quizzes & more.</h2>
            <Signup />
          </div>
        </div>
      </div>
